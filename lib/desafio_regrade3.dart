...
levando em consideração que será considerado o argumento vário como valor a ser encontrado, 
logo, poderá ter apenas um valor necessáriamente "vazio".
*/
...
void main() {
  ...
  num result1 = a + x;
  num result2 = c * b;
  num valorDeX = result2 / result1;

  print('Regra de 3');
  print(' a + x =   $result1');
  print(' c * b =   $result2');
  print(' 240 / 16 =  ');
  print(' o valor de x é: $valorDeX');
}
